...
[Download AgSwarm v0.2.15](https://github.com/yyin9116/AgSwarm/releases/tag/v0.2.15)
...
- Release notes come from `docs/releases/<tag>.md` when present, for example [docs/releases/v0.2.15.md](docs/releases/v0.2.15.md).
...
- Tagged release builds publish `latest.json` plus `.sig` files next to the Tauri updater bundles: macOS Apple Silicon `.app.tar.gz` and Windows x64 setup executable. The macOS DMG remains the manual installer.
...
AgSwarm is under active development. The current public desktop release is `v0.2.15`; platform claims, screenshots, and release notes should be kept aligned with actual GitHub Release artifacts.
